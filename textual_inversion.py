...
class TextualInversionDataset(Dataset):
    def __init__(
        ...
        all_image_paths = [os.path.join(self.data_root, file_path) for file_path in os.listdir(self.data_root) if file_path.lower().endswith(".png")]

        if data_num is not None:
            self.image_paths = all_image_paths[:data_num]
        else:
